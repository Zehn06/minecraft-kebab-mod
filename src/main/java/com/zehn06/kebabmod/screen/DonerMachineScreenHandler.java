...
public class DonerMachineScreenHandler extends ScreenHandler {
	...
	public DonerMachineScreenHandler(int syncId, PlayerInventory playerInventory, PacketByteBuf buf) {
		this(syncId, playerInventory, new SimpleInventory(4), new ArrayPropertyDelegate(3));
	}
	
	public DonerMachineScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
		...
		this.addSlot(new Slot(inventory, 1, 56, 53)); // Fuel (optional)
		this.addSlot(new Slot(inventory, 2, 116, 35)); // Output
		this.addSlot(new Slot(inventory, 3, 26, 35)); // Knife
